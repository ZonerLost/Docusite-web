...
const SiteInspectionReportTemplate: React.FC<SiteInspectionReportTemplateProps> = ({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-white p-8" style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      {photoPreview && typeof document !== "undefined"
        ? createPortal(
            <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-black/60 p-4 pt-8 sm:p-6">
              <div className="relative z-[10010] w-full max-w-3xl rounded-lg bg-white p-4 shadow-xl max-h-[calc(100vh-48px)] overflow-y-auto">
                <button
                  type="button"
